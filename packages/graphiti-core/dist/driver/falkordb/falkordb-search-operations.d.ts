...
export declare class FalkorSearchOperations implements SearchOperations {
    ...
    episodeFulltextSearch(driver: GraphDriver, query: string, _searchFilter: SearchFilters, groupIds?: string[] | null, limit?: number): Promise<EpisodicNode[]>;
